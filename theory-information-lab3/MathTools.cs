...
namespace theory_information_lab3
{
    public static class MathTools
    {
        ...
        //public static long FastPowMul(long foundation, long degree, long multiplier, long n)
        //{
        //    //multiplier * foundation^degree mod n

        //    long res = multiplier % n;           // Инициализация результата (m mod p)
        //    foundation = foundation % n;         // Нормализация y по модулю p

        //    while (degree > 0)
        //    {
        //        if ((degree & 1) == 1)  // Если k нечётное (младший бит = 1)
        //        {
        //            res = (res * foundation) % n;  // Умножаем результат на y и берём mod p
        //        }

        //        foundation = (foundation * foundation) % n;  // Возводим y в квадрат по модулю p
        //        degree >>= 1;           // Сдвигаем k вправо (делим на 2)
        //    }
